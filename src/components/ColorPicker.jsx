  ...
  return (
    <div className="py-6 w-[100%]">
      <div className="flex justify-between items-center">
        ...
        <p className="text-[20px] baskervville-400">and get the painting.</p>
      </div>
